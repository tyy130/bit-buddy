...
{self._get_personality_name()}: """
        ...
        try:
            ...
            return {"answer": answer, "aside": aside, "source": "microllm"}
    ...
    def _fallback_response(self, query: str, health: str) -> Dict[str, str]:
        ...
        aside = (
            "Running on backup personality circuits"
            if health != "healthy"
            else "Feeling pretty good!"
        )

        return {"answer": answer, "aside": aside, "source": "fallback"}
    ...
    def _generate_aside(self, health: str) -> str:
        ...
        asides = {
            ...
            "sick": [
                "Not feeling great",
                "My circuits feel sluggish",
                "Something's definitely wrong",
            ],
            "critical": [
                "Help! Something's very wrong!",
                "I can barely think!",
...
if __name__ == "__main__":
    ...
    # Set file context
    file_summary = {"documents": 1, "downloads": 1, "photos": 0, "projects": 2, "total_files": 847}
