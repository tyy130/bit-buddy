...
class BitBuddy:
    ...
    def _rag_query(self, query: str) -> str:
        ...
        if "document" in query_lower or "doc" in query_lower:
            ...
            return "I notice some photos in different folders. Want me to help you find specific ones?"
            ...
            return f"I'm constantly exploring your drive - there's a lot going on in here! What specific files are you looking for?"
        else:
    ...
    def _scan_environment(self):
        ...
        try:
            ...
            self._log_event("scan", f"Learned about {self.known_locations['total_files']} files in your space")
            self.health_status = "healthy"
