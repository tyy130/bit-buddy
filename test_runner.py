...
class TestRunner:
    ...
    def run_compatibility_tests(self) -> Dict[str, Any]:
        ...
        required_packages = [
            "fastapi", "uvicorn", "watchdog", "requests", 
            "cryptography", "psutil", "pydantic"
        ]
        ...
        optional_packages = [
            "sentence_transformers", "chromadb", "torch", 
...
def main():
    ...
    parser.add_argument("--stress-duration", type=int, default=30, help="Stress test duration (seconds)")
